...
img_gaussain = cv.GaussianBlur(src=im_deskewed, ksize=(11,11), sigmaX=0, sigmaY=0)
...
# ret2,im_thres = cv.threshold(apply_adaptive_threshold(im_thresh_adapt,'gaussian'),0,255,cv.THRESH_BINARY+cv.THRESH_OTSU)
...
# # find canny edge
# edges = cv.Canny(im_thresh_adapt,100,200)
# show_image(edges)
