...
def captch_ex(file_name):
    ...
    ret, mask = cv2.threshold(img2gray, 30, 200, cv2.THRESH_BINARY)
    image_final = cv2.bitwise_and(img2gray, img2gray, mask=mask)
    ret, new_img = cv2.threshold(image_final, 30, 200, cv2.THRESH_BINARY)  # for black text , cv.THRESH_BINARY_INV
    '''
